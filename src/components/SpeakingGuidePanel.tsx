...
export function SpeakingGuidePanel({ id }: SpeakingGuidePanelProps) {
  return (
    ...
    >
      <h3 id="speaking-guide-title" className="speaking-guide__title">
        設定與說明
      </h3>
      ...
      >
        <h4 id="speaking-guide-quick-title" className="speaking-guide__heading">
          快速開始
        </h4>
      ...
      <section
        ...
        className="speaking-guide__section speaking-guide__section--anchor"
        aria-labelledby="speaking-guide-oral-heading"
      >
        <h4 id="speaking-guide-oral-heading" className="speaking-guide__heading">
          口說模式（Live 與語音管道）
        </h4>
        <ul className="speaking-guide__list">
          <li>
            ...
            <code className="speaking-guide__code">VITE_GEMINI_API_KEY</code>
            。
          </li>
          <li>
      ...
      >
        <h4 id="speaking-guide-env-title" className="speaking-guide__heading">
          環境與金鑰
        </h4>
        <ul className="speaking-guide__list">
          <li>
            在專案根目錄的 <code className="speaking-guide__code">.env</code>{" "}
            設定變數（Vite 暴露給前端的前綴為 <code className="speaking-guide__code">VITE_</code>
            ）。
          </li>
          <li>
            文字與 Gemini Live 需要{" "}
      ...
      >
        <h4 id="speaking-guide-history-title" className="speaking-guide__heading">
          對話紀錄
        </h4>
        <ul className="speaking-guide__list">
          <li>
